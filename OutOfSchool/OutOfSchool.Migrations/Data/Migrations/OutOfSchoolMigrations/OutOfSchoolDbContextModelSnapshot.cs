...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LanguageStudySubject", b =>
                {
                    ...
                    b.HasKey("LanguagesId", "StudySubjectId");

                    b.HasIndex("StudySubjectId");

                    b.ToTable("LanguageStudySubject");
                });
            ...
            modelBuilder.Entity("OutOfSchool.Services.Models.StudySubject", b =>
                {
                    ...
                    b.Property<bool>("IsPrimaryLanguageUkrainian")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<long>("PrimaryLanguageId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LanguageStudySubject", b =>
                {
                    b.HasOne("OutOfSchool.Services.Models.Language", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OutOfSchool.Services.Models.StudySubject", b =>
                {
                    b.HasOne("OutOfSchool.Services.Models.Language", "PrimaryLanguage")
                        .WithMany()
